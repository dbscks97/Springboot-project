				...
				<div class="col-md-7 qt">
						...
						<div>							
								<button class="btn btn-primary" type="button"
										onclick="location='notice_bbs_cont?bbs_no=${b.bbs_no}&page=${page}&state=edit';">수정</button>
								<button class="btn btn-primary" type="button"
										onclick="location='notice_bbs_cont?bbs_no=${b.bbs_no}&page=${page}&state=del';">삭제</button>
